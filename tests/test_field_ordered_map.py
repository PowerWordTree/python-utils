...
from pwt.utils.field_ordered_map import FieldOrderedMap, QueryField
...
def sample_list():
    ...
    m = FieldOrderedMap(Person, ["name", "age"])
    m.push_all(people)
    return m, people
...
def test_push_all_behaviour():
    mlist = FieldOrderedMap(Person, ["name"])
